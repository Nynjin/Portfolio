	...
	return (
		...
		>
			...
			<a href="https://www.linkedin.com/in/moncef-hassani-b3a358222/" target="_blank">
				<img src="linkedin.png" alt="LinkedIn" className="w-8 sm:w-12" />
			</a>

			<a href="https://github.com/Nynjin" target="_blank">
				<img src="github.png" alt="GitHub" className="w-8 sm:w-12" />
			</a>

			<a href="CV.pdf" target="_blank" rel="noopener noreferrer">
				<img src="CV.png" alt="Download CV" className="w-8 sm:w-12" />
			</a>
		</motion.div>
	);
};